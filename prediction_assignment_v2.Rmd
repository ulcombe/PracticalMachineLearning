...
The goal of this assignment is to predict the manner in which participants did the exercise. This is the "classe" variable in the training set. Any of the other variables can me used to predict with. This report will describe how you built your model, how you used cross validation, what you think the expected out of sample error is, and describe the choices you did. The final prediction model was used to predict 20 different test cases. 
